...
const FAQPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'Наша модель машинного обучения обучена на большом датасете экзаменационных ответов. Она анализирует транскрибацию устных ответов студентов, учитывая грамматику, полноту ответа, соответствие вопросу и другие критерии для выставления оценки от 1 до 2 баллов.',
    },
    {
