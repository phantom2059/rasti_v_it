# Система автоматической оценки устных ответов на экзамене по русскому языку
# Программа создана в рамках кейса "Sigma" хакатона "Расти в IT"
...
1. **Анализ изображений** — Qwen2.5-VL (vision-language модель)
...
## Типы вопросов и максимальные баллы

| № вопроса | Тип задания | Макс. балл | Описание |
|-----------|-----------|-----------|---------|
| 1 | Описание картинки (Part 1) | 1 | Простое описание изображения |
| 2 | Диалог (Part 2) | 2 | Ведение диалога с экзаменатором |
| 3 | Описание картинки (Part 2) | 1 | Более сложное описание изображения |
| 4 | Общий вопрос (Part 3) | 2 | Ответ на общий вопрос |
